...
class __TwigTemplate_1da23000aa3bd5cbc887544ba224bccf8ff28916c3cf33700c066fb453d4b2f8 extends Twig_Template
{
...
$context["language_type"], "type", array())) . "-wrapper"));
            // line 30
            echo "  <div";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["language_type"], "attributes", array()), "addClass", array(0 => (isset($context["language_classes"]) ? $context["language_classes"] : null)), "method"), "html", null, true));
            echo ">
    <h2>";
            // line 31
...
";
    ...
    {
        return new Twig_Source("", "core/themes/stable/templates/admin/language-negotiation-configure-form.html.twig", "/home/wolfin/public_html/web/core/themes/stable/templates/admin/language-negotiation-configure-form.html.twig");
    }
}
